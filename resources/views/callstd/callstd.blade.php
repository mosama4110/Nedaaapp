...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إدارة
                    الطلاب </span>
            </div>
        </div>
...
@section('content')
    ...
    <!-- row -->
    <div id="app">
        <reciver-component></reciver-component>
    </div>
    {{-- <div class="row">
        <div class="col-xl-12">
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="card-body center">
                        @foreach ($student as $x)
                            <div class="main-img-user avatar-xxl d-none d-sm-block"><img alt="avatar"
                                    class="rounded-circle" src="user_id/school-student-icon-18.png"></div>
                            <p>
                            <h4 class="content-title mb-0 my-auto">
                                <p>{{ $x->student_name }}</p>
                            </h4>
                            <p>
                            <h4 class="content-title mb-0 my-auto">{{ $x->student_nameen }}</h4>
                            </p>
                            <p>
                            <h4 class="content-title mb-0 my-auto">{{ $x->Semester }}</h4>
                            </p>
                    </div>
                    @endforeach
